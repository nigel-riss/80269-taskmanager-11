...
/**
 * Returns board container markup
...
/**
 * Returns card edit form markup
 * @return {string} from markup
 */
const getFormMarkup = () => {
  return (
...
/**
 * Returns load more button markup
 * @return {string} load more markup
 */
